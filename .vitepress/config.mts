          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                { text: 'Bounce Handling with toSend', link: '/docs/bounce-handling-with-tosend' },
              ],
            },
          ],
        },
          ...
          items: [
            {
              ...
              items: [
                ...
                { text: 'Email Patterns', link: '/docs/email-patterns' },
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                { text: 'Abandon Cart Automation (WooCommerce)', link: '/docs/abandon-cart-automation' },
                { text: 'FluentCart Abandon Cart Automation', link: '/docs/fluentcart-abandon-cart-automation' },
              ],
            },
            {
              text: 'Event Tracking',
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                { text: 'AffiliateWP Integration', link: '/docs/affiliatewp-integration-with-fluentcrm' },
                { text: 'Fluent Booking Integration', link: '/docs/fluent-booking-integration-with-fluentcrm' },
                { text: 'FluentBoards Integration', link: '/docs/fluentboards-integration-with-fluentcrm' },
                { text: 'FluentSupport Integration', link: '/docs/fluentsupport-integration-with-fluentcrm' },
              ],
            },
            {
          ...
          items: [
            {
              ...
              items: [
                ...
                { text: 'Global Search', link: '/docs/global-search' },
                { text: 'Dark Mode', link: '/docs/dark-mode' },
                { text: 'RTL Support', link: '/docs/rtl-support' },
              ],
            },
            {
