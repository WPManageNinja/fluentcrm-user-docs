...
![event tracking 01](/event-tracking/event-tracking-automation/event-tracking-01-scaled.webp)

A pop-up will appear, enable the **Checkbox** and click the **Save Settings** button.

![02](/event-tracking/event-tracking-automation/02-scaled.webp)
...
![03](/event-tracking/event-tracking-automation/03.webp)
...
![04](/event-tracking/event-tracking-automation/04.webp)
...
![05](/event-tracking/event-tracking-automation/05.webp)
...
![06](/event-tracking/event-tracking-automation/06.webp)

Click the **Add Event Tracking** action blocks for your target contact.

![07](/event-tracking/event-tracking-automation/07-scaled.webp)
...
![08](/event-tracking/event-tracking-automation/08-scaled.webp)

Now publish the automation by enabling the toggle in the top right corner.

![09](/event-tracking/event-tracking-automation/09.webp)
