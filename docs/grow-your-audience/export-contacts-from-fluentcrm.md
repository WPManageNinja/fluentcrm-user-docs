...
To Export All Contacts please go to the **FluentCRM Dashboard** ➜ **Contacts** and then click on the **More Actions > Export** button from the top right corner dropdown option.
