...
> **Tip:** Want to write or rewrite copy with AI? Connect a provider on the [AI Model Setup](/ai-model-setup) page and the Smart Headings, Smart Buttons, and Magic Image tools will appear directly in the block toolbar.
