...
![Drip](/migrating-from-other-platforms/migrating-into-fluentcrm-from-drip/drip-1.webp)

5.  Next, scroll down to find your **API Token**. Copy this token as well. Keep both of these handy for the next step.

![Drip](/migrating-from-other-platforms/migrating-into-fluentcrm-from-drip/drip-2.webp)
...
![Drip](/migrating-from-other-platforms/migrating-into-fluentcrm-from-drip/drip-3.webp)

2.  A window will pop up. Select the **Import From Other Providers** option and click **Next**.

![Drip](/migrating-from-other-platforms/migrating-into-fluentcrm-from-drip/drip-4.webp)

3.  Click on the **Drip** logo from the list of available marketing software and hit **Next (Connect)**.

![Drip](/migrating-from-other-platforms/migrating-into-fluentcrm-from-drip/drip-5.webp)
...
![Drip](/migrating-from-other-platforms/migrating-into-fluentcrm-from-drip/drip-6.webp)
...
![Drip](/migrating-from-other-platforms/migrating-into-fluentcrm-from-drip/drip-7.webp)
...
![Drip](/migrating-from-other-platforms/migrating-into-fluentcrm-from-drip/drip-8.webp)
